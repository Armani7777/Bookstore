...
func Panel(w http.ResponseWriter, r *http.Request) {
	...
	ts, err := template.ParseFiles("D:/Java/BookStore-master/static/html/admin.html")
	if err != nil {
...
func Add(w http.ResponseWriter, r *http.Request) {
	ts, err := template.ParseFiles("D:/Java/BookStore-master/static/html/add.html")
	if err != nil {
		log.Println(err.Error())
		http.Error(w, "Internal Server Error", 500)
		return
...
func Edit(w http.ResponseWriter, r *http.Request) {
	...
	ts, err := template.ParseFiles("D:/Java/BookStore-master/static/html/edit.html")
	if err != nil {
		log.Println(err.Error())
		http.Error(w, "Internal Server Error", 500)
		return
